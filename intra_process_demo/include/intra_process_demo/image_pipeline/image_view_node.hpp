...
public:
  explicit ImageViewNode(
    const std::string & input, const std::string & node_name = "image_view_node", bool show_watermark=true)
  : Node(node_name, "", true)
  {
    // Create a subscription on the input topic.
    sub_ = this->create_subscription<sensor_msgs::msg::Image>(
      input, [node_name, show_watermark](const sensor_msgs::msg::Image::SharedPtr msg) {
